...
export const ContactForm = ({
  ...
  return (
    <form onSubmit={onSubmit} ref={formRef} className="space-y-4 w-full">
      <h2 className="text-xl font-semibold text-center">Fill the form to download brochure</h2>
      <div>
        <label className="block font-medium mb-1">Are you interested in BPTP Amstoria Verti Greens?</label>
